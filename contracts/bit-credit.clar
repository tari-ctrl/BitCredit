...
;; Creates a new loan for the caller if they meet eligibility requirements
...
;; Processes a loan repayment and updates loan status
...
;; Computes principal plus interest for a loan
...
;; Increases score for successful repayments, decreases for defaults
...
;; Adds a new loan ID to user's active loans list
...
;; Retrieves user credit profile information
...
;; Retrieves the list of a user's active loans
...
;; Updates a loan's status to defaulted if conditions are met
